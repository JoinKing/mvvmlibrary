...
import com.hwq.mvvmlibrary.utils.LoginDataUtils;
...
//        retrofit = null;
    ...
    public RetrofitClient addHeaders(String key,String value) {
    ...
    public void RetrofitClient() {
        ...
        okHttpClient = new OkHttpClient.Builder()
                ...
                .addInterceptor(new LoggingInterceptor
                        ...
                        .addHeader("Content-Type", "application/json") // 添加打印头, 注意 key 和 value 都不能是中文
                        .build()
                )
