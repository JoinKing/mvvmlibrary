    ...
    public static void loadDex(Context context) {
        ...
        for (File dex : loadedDex) {
            ...
            try {
                ...
                Field pathListfailed = baseDexClazzLoader.getDeclaredField(Constants.PATH_LIST);
                pathListfailed.setAccessible(true);
                Object pathListObject = pathListfailed.get(pathClassLoader);
                ...
                Field myPathListfailed = myDexClazzLoader.getDeclaredField(Constants.PATH_LIST);
                myPathListfailed.setAccessible(true);
                Object myPathListObject = myPathListfailed.get(dexClassLoader);
