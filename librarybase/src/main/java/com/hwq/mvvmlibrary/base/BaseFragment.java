...
public abstract class BaseFragment<V extends ViewDataBinding, VM extends BaseViewModel> extends RxFragment implements IBaseView {
    ...
    private void registorUIChangeLiveDataCallBack() {
        ...
        viewModel.getUC().getStartContainerActivityEvent().observe(this, new Observer<Map<String, Object>>() {
            ...
            public void onChanged(@Nullable Map<String, Object> params) {
                ...
                if (params == null) {
                    startContainerActivity(canonicalName);
                } else {
                    Object o = params.get(BaseViewModel.ParameterField.RESULT_CODE);
                    if (o == null) {
                        startContainerActivity(canonicalName, bundle);
                    } else {
                        startContainerActivity(canonicalName, bundle, (int) o);
                    }
                }
     ...
     * @param bundle        跳转所携带的信息
     */
    public void startContainerActivity(String canonicalName, Bundle bundle, int result) {
        Intent intent = new Intent(getContext(), ContainerActivity.class);
        intent.putExtra(ContainerActivity.FRAGMENT, canonicalName);
        if (bundle != null) {
            intent.putExtra(ContainerActivity.BUNDLE, bundle);
