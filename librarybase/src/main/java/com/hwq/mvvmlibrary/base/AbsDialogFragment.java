...
import com.hwq.mvvmlibrary.utils.ClickUtil;
...
public abstract class AbsDialogFragment extends DialogFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (mLifeCycleListener != null) mLifeCycleListener.onDialogFragmentShow(this);
    }


    @Override
    public void onDestroy() {
        if (mLifeCycleListener != null) mLifeCycleListener.onDialogFragmentHide(this);
    ...
    protected <T extends View> T findViewById(int id) {
        if (mRootView != null) return mRootView.findViewById(id);
        return null;
    }
