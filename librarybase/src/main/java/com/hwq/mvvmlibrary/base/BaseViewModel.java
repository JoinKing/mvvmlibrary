...
import com.hwq.mvvmlibrary.widget.title.NoDataViewModel;
...
public class BaseViewModel<M extends BaseModel> extends AndroidViewModel implements IBaseViewModel, Consumer<Disposable> {
    ...
    public TitleViewModel titleViewModel = new TitleViewModel(getApplication());
    public ObservableInt noData = new ObservableInt(View.GONE);

    public NoDataViewModel noDataViewModel = new NoDataViewModel(getApplication());
    ...
    public void startActivityForResult(Class<?> clz, Bundle bundle) {
        ...
        uc.startActivityForResultEvent.setValue(params);
    }
    /**
     * 跳转容器页面
     *
     ...
     * @param bundle        跳转所携带的信息
     */
    public void startContainerActivity(String canonicalName, Bundle bundle, int resultCode) {
        Map<String, Object> params = new HashMap();
        params.put(ParameterField.CANONICAL_NAME, canonicalName);
