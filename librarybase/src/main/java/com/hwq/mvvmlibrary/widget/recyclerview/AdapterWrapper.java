    ...
    public final void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position,
        ...
        if (itemView instanceof SwipeMenuLayout && mSwipeMenuCreator != null) {
            ...
            if (leftMenu.hasMenuItems()) {
                ...
                leftMenuView.createMenu(holder, leftMenu, menuLayout, SwipeRecyclerView.LEFT_DIRECTION, mOnItemMenuClickListener);
            ...
            if (rightMenu.hasMenuItems()) {
                ...
                rightMenuView.createMenu(holder, rightMenu, menuLayout, SwipeRecyclerView.RIGHT_DIRECTION, mOnItemMenuClickListener);
